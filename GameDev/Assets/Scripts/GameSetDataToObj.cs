    ...
    public void SetData()
    {
        foreach (System.Collections.Generic.KeyValuePair<string, GameObject> kvp in DataToSet.Dictionary)
        {
            ...
            if (kvp.Key.Contains("Color", StringComparison.OrdinalIgnoreCase))
            {
                ...
                else if (colorImageComponent != null) colorImageComponent.color = newColor;
                else if (colorParticalSystem != null) colorParticalSystem.startColor = newColor;
